...
$(function () {
  ...
  if (window.innerWidth < 1200) {
    ...
    $('.programm-slider').slick({
      ...
      slidesToScroll: 1,
      speed: 700,
      prevArrow: $('.programm-slider__arrow-left'),
      nextArrow: $('.programm-slider__arrow-right'),
      responsive: [{
          breakpoint: 1200,
          settings: {
            slidesToShow: 2,
  ...
  $('.liked-slider').slick({
    ...
    slidesToScroll: 1,
    dots: true,
    prevArrow: $('.liked-slider__left'),
    nextArrow: $('.liked-slider__right')
  });
  ...
  $('.feedback-slider').slick({
    ...
    slidesToScroll: 1,
    speed: 700,
    prevArrow: $('.feedback-slider__arrow-left'),
    nextArrow: $('.feedback-slider__arrow-right'),
    responsive: [{
        breakpoint: 991,
        settings: {
          slidesToShow: 1,
  ...
  // Видео Отзывы
  $('.feedback-slider-video').slick({
    infinite: true,
    slidesToShow: 2,
    slidesToScroll: 1,
    speed: 500,
    prevArrow: $('.feedback-slider-video__arrow-left'),
    nextArrow: $('.feedback-slider-video__arrow-right'),
    responsive: [{
        breakpoint: 1024,
        settings: {
          slidesToShow: 1,
  ...
  // Селектор на форме - выбор тарифа - стилизация
  $('.stock-form-selectize').selectize();


  // Появление фиксированного меню
  function showMenuFixed() {
    const menu = document.querySelector('.navigation-fixed'),
      arrowTop = document.querySelector('.scroll-up');
...
// Ответы на вопросы - выпадающий список
function showAnswer() {
  ...
  faq.addEventListener(`click`, (event) => {
    ...
    if (target.closest(`.questions-block`) || target.closest(`.questions-block__arrow`)) {
      if (target.closest(`.questions-block__arrow`)) {
        target.parentNode.parentNode.classList.toggle('active-question');
      } else {
        target.parentNode.classList.toggle('active-question');
      }
    }
  });
}
...
// Показ выпадающего мобильного меню 
function showMenuMobile() {
  const btn1 = document.querySelector('.navigation-fixed__mobile-btn-open'),
    btn2 = document.querySelector('.header-mobile__menu'),
    close = document.querySelector('.mobile-menu-navigation-fixed__close'),
    menu = document.querySelector('.mobile-menu-navigation-fixed');
  ...
  menu.addEventListener('click', function (event) {
    ...
    if (target.closest(`.mobile-menu-navigation-fixed__close`) || target.closest(`a`)) {
